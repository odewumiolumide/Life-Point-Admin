...
const defaultSubjects = {
  preNusery: ["Literacy", "Numeracy", "Health Habits",  "Social Habits", "Pre-Science","Handwriting", "Poem", "Songs And Rhythms", "Colouring/Drawing"],
  ...
  prebasic3: ["Literacy (Letter Work)", "Literacy (Language Domain)", "Numeracy", "Health Habits", "Social Habits", "Physical And Health Education", "Basic Science", "Civic Education", "Cultural And Creative Art", "Personal Development","Songs And Rhythm", "Handwriting", "Dictation"],
  ...
  basic4: ["English Language", "Mathematics", "Basic Science", "Physical And Health Education", "Religion Studies","Nigerian History","Social And Citizenship Studies", "Cultural And Creative Art", "Basic Digital Literacy", "Prevocational Studies", "French", "Nigerian Language","Dictation"],
  basic5: ["English Language", "Mathematics", "Basic Science", "Physical And Health Education", "Religion Studies","Nigerian History","Social And Citizenship Studies", "Cultural And Creative Art", "Basic Digital Literacy", "Prevocational Studies", "French", "Nigerian Language","Dictation"],
  jss1: ["English Language","Mathematics","Physical And Health Education", "Business studies (BS)", "Social and citizenship studies", "Entrepreneurship", "Digital Technology", "Christian Religion Studies (CRS)", "Cultural and creative Art (CCA)", "Nigeria History","Dictation", "Intermediate Science", "French"],
  jss2: ["English Language","Mathematics", "Physical And Health Education", "Business studies (BS)", "Social and citizenship studies", "Entrepreneurship", "Digital Technology", "Christian Religion Studies (CRS)", "Cultural and creative Art (CCA)", "Nigeria History","Dictation", "Intermediate Science", "French"],
  jss3: ["English Language","Mathematics", "Physical And Health Education", "Business studies (BS)", "Social and citizenship studies", "Entrepreneurship", "Digital Technology", "Christian Religion Studies (CRS)", "Cultural and creative Art (CCA)", "Nigeria History","Dictation", "Intermediate Science", "French"],
  sss1: ["Mathematics","English","Entrepreneurship","Digital Technology","Phonics"],
  sss2: ["Mathematics","English","Entrepreneurship","Digital Technology","Phonics"],
  sss3: ["Mathematics","English","Entrepreneurship","Digital Technology","Phonics"]
};
